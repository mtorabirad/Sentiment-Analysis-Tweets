...
# Sort with the number of followers: tmp = df.sort_values(by=['num_follower'], ascending=False)
# remove rows with repeating username: tmp_2 = tmp.drop_duplicates('username', inplace=False)
# tmp_3 = tmp_2.head(10)
